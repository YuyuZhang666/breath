...
class TurnTelemetry:
    ...
    action_override_log: tuple[str, ...] = ()
    validated_weapon_action_log: tuple[str, ...] = ()
    opening_stage: str = 'inactive'
    opening_weapon_count: int = 0
    opening_wall_count: int = 0
    opening_workers_with_stone: int = 0
    opening_workers_returned: int = 0
    opening_controllers_ready: int = 0
    opening_gate_closed: bool = False
    opening_remaining_daylight: int = 0
    opening_mine_eta: int = -1
    opening_return_eta: int = -1
    opening_construction_eta: int = 0
    opening_recall_eta: int = -1
    opening_worker_log: tuple[str, ...] = ()
    opening_final_action_log: tuple[str, ...] = ()
    controller_assignment_log: tuple[str, ...] = ()
    planned_wall_target: str = ''
    planned_build_position: str = ''
...
class TelemetryRecorder:
    ...
    def finish(
        ...
        sample = TurnTelemetry(
            ...
            day_no=active.day_no,
            round_in_phase=active.round_in_phase,
            phase=active.phase,
            ...
            action_override_log=active.action_override_log,
            validated_weapon_action_log=active.validated_weapon_action_log,
            opening_stage=active.opening_stage,
            opening_weapon_count=active.opening_weapon_count,
            opening_wall_count=active.opening_wall_count,
            opening_workers_with_stone=active.opening_workers_with_stone,
            opening_workers_returned=active.opening_workers_returned,
            opening_controllers_ready=active.opening_controllers_ready,
            opening_gate_closed=active.opening_gate_closed,
            opening_remaining_daylight=active.opening_remaining_daylight,
            opening_mine_eta=active.opening_mine_eta,
            opening_return_eta=active.opening_return_eta,
            opening_construction_eta=active.opening_construction_eta,
            opening_recall_eta=active.opening_recall_eta,
            opening_worker_log=active.opening_worker_log,
            opening_final_action_log=active.opening_final_action_log,
            controller_assignment_log=active.controller_assignment_log,
            planned_wall_target=active.planned_wall_target,
            planned_build_position=active.planned_build_position,
